...
class FilterStateSerializationTest {
    ...
    private class FakePropertyRepository : PropertyRepository {
        ...
        override suspend fun softDeletePropertyLocalOnly(id: String, timestamp: Long): Int = throw UnsupportedOperationException()
        override suspend fun markPropertyTextUnsynced(id: String): Int = throw UnsupportedOperationException()
        override suspend fun deleteOldDeletedProperties(thirtyDaysAgo: Long) = throw UnsupportedOperationException()
        override suspend fun transferPropertyOwnership(propertyId: String, newOwnerId: String) = throw UnsupportedOperationException()
        ...
        override suspend fun findByCoordinates(latMin: Double, latMax: Double, lngMin: Double, lngMax: Double): List<Property> = throw UnsupportedOperationException()
    }
}
